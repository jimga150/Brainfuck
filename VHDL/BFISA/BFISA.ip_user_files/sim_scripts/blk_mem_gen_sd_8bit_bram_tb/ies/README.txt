...
#
# Generated by export_simulation on Sat Aug 21 15:35:18 -0400 2021
#
################################################################################
...
./blk_mem_gen_sd_8bit_bram_tb.sh
...
'-reset_run' switch to the './blk_mem_gen_sd_8bit_bram_tb.sh' script.

./blk_mem_gen_sd_8bit_bram_tb.sh -reset_run
...
./blk_mem_gen_sd_8bit_bram_tb.sh -noclean_files

For more information on the script, please type './blk_mem_gen_sd_8bit_bram_tb.sh -help'.
