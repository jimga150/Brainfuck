...
#
# Generated by export_simulation on Thu Jun 24 16:13:45 -0400 2021
#
################################################################################
...
'-reset_run' switch to the './blk_mem_text.sh' script.

./blk_mem_text.sh -reset_run
...
./blk_mem_text.sh -noclean_files

For more information on the script, please type './blk_mem_text.sh -help'.
