...
#
# Generated by export_simulation on Tue Jun 22 01:18:56 -0400 2021
#
################################################################################
...
'-reset_run' switch to the './dist_mem_rom.sh' script.

./dist_mem_rom.sh -reset_run
...
./dist_mem_rom.sh -noclean_files

For more information on the script, please type './dist_mem_rom.sh -help'.
